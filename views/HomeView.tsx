        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { name: 'Хип-хоп', genreId: 3, gradient: 'from-yellow-500 to-green-500' },
              { name: 'Электроника', genreId: 8, gradient: 'from-blue-500 to-cyan-500' },
              { name: 'Нью-эйдж', genreId: 51, gradient: 'from-green-500 to-teal-500' },
              { name: 'Танцевальная', genreId: 11, gradient: 'from-orange-500 to-red-600' },
              { name: 'Альтернатива', genreId: 7, gradient: 'from-purple-600 to-indigo-600' },
              { name: 'Металл', genreId: 10, gradient: 'from-gray-700 to-black' },
              { name: 'Дабстеп', genreId: 29, gradient: 'from-indigo-500 to-purple-500' },
              { name: 'Драм-н-бэйс', genreId: 31, gradient: 'from-yellow-600 to-red-600' },
              { name: 'Транс', genreId: 1, gradient: 'from-cyan-500 to-blue-600' },
              { name: 'Шансон', genreId: 14, gradient: 'from-yellow-700 to-orange-700' },
              { name: 'Классика', genreId: 28, gradient: 'from-yellow-200 to-yellow-500' },
              { name: 'Джаз', genreId: 39, gradient: 'from-indigo-400 to-purple-400' },
              { name: 'Регги', genreId: 30, gradient: 'from-green-600 to-emerald-600' },
              { name: 'Кантри', genreId: 42, gradient: 'from-orange-400 to-amber-600' },
              { name: 'Латино', genreId: 32, gradient: 'from-red-500 to-pink-600' },
              { name: 'Блюз', genreId: 17, gradient: 'from-blue-700 to-indigo-800' },
